    ...
    if (pizza.tipo === 'promocion') {
      ...
      container.innerHTML += `
        <div class="col-6 col-md-4">
          <a class="card pizza-card text-decoration-none" href="https://wa.me/573138355540?text=${mensaje}" target="_blank" rel="noopener" aria-label="Conocer más sobre la promoción por WhatsApp">
...
function confirmarPedido() {
  ...
  let url = `https://wa.me/573138355540?text=${encodeURIComponent(mensaje)}`;
